...
class LogEntryParserTestCase(unittest.TestCase):
    ...
    def test_parser(self):
        ...
        parsed_log_entry = log_entry_parser(log_entry)

        expected = {'logger_name': 'localhost', 'level_name': 'INFO', 'message': 'hello zsolti', 'datetime': '2017-06-23 22:33:43,988'}
        self.assertEqual(expected, parsed_log_entry)